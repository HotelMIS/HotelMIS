 ...
 * 被AbstractSecurityInterceptor调用，
 * 它用来作最终访问控制的决定。这个AccessDecisionManager接口包含三个方法：
 * 
 * void decide(Authentication authentication, Object
 * secureObject,List<ConfigAttributeDefinition> config) throws
 * AccessDeniedException; boolean supports(ConfigAttribute attribute); boolean
